    ...
    <div className="min-h-dvh bg-neutral-100 flex items-center justify-center p-4">
      <div className="relative w-full max-w-sm overflow-hidden rounded-3xl bg-neutral-950 text-white shadow-2xl">
        ...
        <div className="px-6 pb-8 pt-6">
          ...
          <p className="mt-2 text-neutral-300">{t('onboarding.subtitle')}</p>

          <div className="mt-4">
            <Badge icon={<WifiOffIcon />}>{t('onboarding.offline')}</Badge>
          </div>
          ...
          <div className="mt-10">
            ...
            <p className="mt-4 text-center text-xs text-neutral-400">{t('onboarding.powered')}</p>
          </div>
        </div>
      </div>
    </div>
